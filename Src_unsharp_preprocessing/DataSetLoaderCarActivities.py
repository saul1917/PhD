...
def pruebaDataset():
    ...
    datasetCarActivities = DatasetCarsActivities("C:/Users/saul1/Google Drive/DATASETS_TEMP/auc_distracted_driver_dataset_v2/v1_cam1_no_split", transformations)
